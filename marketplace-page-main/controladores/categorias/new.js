...
export async function editRegister(id) {
    ...
    let categoria = await categoriasServices.listar(id).then(respuesta => respuesta.json());


    txtDescripcion.value = categoria.descripción;
...
async function guardar(e) {
    ...
    await categoriasServices.crear(txtDescripcion.value)
        .then(respuesta => {
